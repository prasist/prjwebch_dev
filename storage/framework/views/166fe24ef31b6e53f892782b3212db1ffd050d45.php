<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $("#nivel1_up").change(function()
        {
            ...
            var urlRoute = "<?php echo url('/nivel1_up/" + campo[0] + "'); ?>";
        ...
        $("#nivel2_up").change(function()
        {
            ...
            //route para chamada funcao passando ID do nivel 4
            var urlRoute = "<?php echo url('/nivel2_up/" + campo[0] + "'); ?>";
  ...
  /*Quando selecionar item no combo nivel1, carrega combo nivel2 com dados relacionados*/
        $("#nivel3_up").change(function()
        {
            ...
            //route para chamada funcao passando ID do nivel 4
            var urlRoute = "<?php echo url('/nivel3_up/" + campo[0] + "'); ?>";
        ...
        $("#nivel4_up").change(function()
        {
            ...
            //route para chamada funcao passando ID do nivel 4
            var urlRoute = "<?php echo url('/nivel4_up/" + campo[0] + "'); ?>";
       ...
       /*Quando selecionar item no combo nivel5, carrega combo nivel4 com dados relacionados*/
        ...
        {
            //route para chamada funcao passando ID do nivel 4
            var urlRoute = "<?php echo url('/nivel5/" + $("#nivel5").val() + "'); ?>";
        ...
        {
            //route para chamada funcao passando ID do nivel 4
            var urlRoute = "<?php echo url('/nivel4/" + $("#nivel4").val() + "'); ?>";
        ...
        {
            //route para chamada funcao passando ID do nivel 4
            var urlRoute = "<?php echo url('/nivel3/" + $("#nivel3").val() + "'); ?>";
        ...
        $("#nivel2").change(function()
        {
            ...
            var urlRoute = "<?php echo url('/nivel2/" + $("#nivel2").val() + "'); ?>";
