...
<?php echo e(\Session::put('titulo', 'Dashboard - ' . \Session::get('label_celulas'))); ?>

<?php echo e(\Session::put('subtitulo', 'Visão Geral')); ?>
       ...
       <div class="row">
          <div class="col-md-12">
             <div class="box-header with-border">
                 <h3 class="box-title">Árvore Hierárquica da Rede</h3>&nbsp;(<i class="text-info">Clique no nível para expandir e exibir os relatório disponíveis.</i>)<?php echo $gerar_treeview; ?>
            ...
            <div class="col-xs-6">
                  ...
                  <option  value="email" data-icon="fa fa-envelope-o">Listagem de E-mails</option>
                   ...
                   <?php if($var_download==""): ?>
                         ...
                         <?php if($var_mensagem=="Nenhum Registro Encontrado"): ?>
                                <br/>
                                <br/>
                                 <div class="alert2 alert-info">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                    <i class="icon fa fa-check"></i> <?php echo e($var_mensagem); ?></h4>
                                </div>
                                <?php echo e($var_mensagem); ?>
                   ...
                   <?php else: ?>
                      ...
                      <a href="<?php echo url($var_download); ?>" class="text" target="_blank">
                        CLIQUE AQUI PARA VISUALIZAR / BAIXAR
                        <?php if(substr($var_download,-3)=="pdf"): ?>
                          <img src="<?php echo e(url('/images/pdf.png')); ?>" alt="Baixar Arquivo" />
                        <?php elseif(substr($var_download,-4)=="xlsx"): ?>
                          <img src="<?php echo e(url('/images/excel.png')); ?>" alt="Baixar Arquivo" />
                        <?php elseif(substr($var_download,-3)=="csv"): ?>
                          <img src="<?php echo e(url('/images/csv.jpg')); ?>" alt="Baixar Arquivo" />
                        <?php elseif(substr($var_download,-4)=="docx"): ?>
                           <img src="<?php echo e(url('/images/microsoft-word-icon.png')); ?>" alt="Baixar Arquivo" />
                        <?php endif; ?>
                      </a>
                    <?php endif; ?>
...
<div id="nao_imprimir_2" class="row">
          <div class="col-lg-4 col-xs-7">
                    <div class="inner">
                         <center><h4>Total <?php echo \Session::get('label_participantes'); ?></h4>
                         </center>
                    </div>
    ...
    <div class="col-md-12">
     ...
     <div id="printable" class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Visão Geral - <?php echo $mostrar_texto; ?></h3>
              ...
              <div class="box box-widget">
                ...
                <div class="box-footer no-padding">
                 ...
                 <div class="row">
                        ...
                        <div class="col-xs-4">
                              <h4>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo \Session::get('label_celulas'); ?></h4>
                              <ul class="nav nav-stacked">

                                    <li>
                                        <a href="#">&nbsp;<?php echo \Session::get('label_celulas'); ?> em Atividade
                                            <span class="pull-left badge bg-blue"><?php echo $total_celulas; ?></span>
                                        </a>
                                    </li>

                                    <li>
                                        <a href="#"><?php echo \Session::get('label_participantes'); ?> :
                                            <span class="pull-right badge bg-green"><?php echo $total_participantes; ?></span>
                                        </a>

                                        <?php if($resumo_tipo_pessoas): ?>
                                        <ul style="list-style-type:none">
                                            <?php foreach($resumo_tipo_pessoas as $item): ?>
                                            <li>
                                                <?php echo $item->nome; ?>

                                                    <span class="pull-right badge bg-blue"><?php echo $item->total; ?></span>
                                            </li>
                                            <?php endforeach; ?>
                                   ...
                                   <?php if($celulas_faixas): ?>
                                         <h4>&nbsp;&nbsp;&nbsp;&nbsp;Por Faixa Etária</h4>

                                          <?php foreach($celulas_faixas as $item): ?>
                                          <li>
                                              <a href="#">&nbsp;<?php echo $item->nome; ?>

                                                  <span class="pull-left badge bg-blue"><?php echo $item->total; ?></span>
                                              </a>
                                          </li>
                                          <?php endforeach; ?>
                                    <?php endif; ?>

                                    <?php if($celulas_publicos): ?>
                                          <h4>&nbsp;&nbsp;&nbsp;&nbsp;Público Alvo</h4>

                                          <?php foreach($celulas_publicos as $item): ?>
                                          <li>
                                              <a href="#">&nbsp;<?php echo $item->nome; ?>
                          ...
                          <div class="col-xs-6">
                              ...
                              <h4>&nbsp;&nbsp;&nbsp;&nbsp;Resumo <?php echo \Session::get('label_encontros'); ?></h4>
                              <ul class="nav nav-stacked">

                                    <li>
                                        <a href="#">&nbsp;Total Geral Presentes
                                            <span class="pull-right badge bg-green"><?php echo $resumo[0]->total_geral; ?></span>
                                        </a>
                                    </li>

                                    <ul style="list-style-type:none">
                                          <li>
                                              Visitantes<span class="pull-right badge bg-blue"><?php echo $resumo[0]->total_visitantes; ?></span>
                                          </li>

                                          <li>
                                              Membros
                                              <span class="pull-right badge bg-yellow"><?php echo $resumo[0]->total_membros; ?></span>
                                          </li>

                                    </ul>

                                    <br/>
                                    <?php foreach($resumo_perguntas as $item): ?>
                                    <li>
                                        <a href="#">&nbsp;<?php echo $item->pergunta; ?>
                          ...
                          <?php else: ?>
                           <div class="col-xs-6">
                                  ...
                                  <h4>&nbsp;&nbsp;&nbsp;&nbsp;Resumo <?php echo \Session::get('label_encontros'); ?> (Mês Corrente)</h4>
                                  <ul class="nav nav-stacked">

                                        <li>
                                            Sem dados estatísticos de <?php echo \Session::get('label_encontros'); ?> até o momento.
                                        </li>
                                  </ul>
                           </div>
...
*/
 function chamar_dashboard(mes, ano) {
         var urlGetUser = '';
         urlGetUser = '<?php echo url("/dashboard_celulas/' +  mes + '/' + ano + '"); ?>';
 ...
 function abrir_relatorio_nivel(tipo, nivel, valor, nome, saida)  {
         var urlGetUser = '';
         urlGetUser = '<?php echo url("/estatisticas_nivel/' +  tipo + '/' + nivel+ '/' + valor + '/' + nome + '/' + saida + '"); ?>';
         window.location.href =urlGetUser;
  }
  ...
  {
          var urlGetUser = '<?php echo url("/estatisticas/' +  tipo + '"); ?>';
          window.location.href =urlGetUser;
  }
 ...
 function chamar_grafico(mes, ano) {
   ...
   //-------------------------Grafico visitantes
      var var_json = (function () {
            ...
            var urlGetUser = '<?php echo url("/grafico_celulas/visitantes/' +  mes + '/' + ano + '"); ?>';
 ...
 function chamar_grafico_2(mes, ano) {
    ...
    //-----------------------Grafico Total Por Tipo de Pessoa
      var var_json = (function () {
            ...
            var urlGetUser = '<?php echo url("/grafico_celulas/tipo_pessoa/' +  mes + '/' + ano + '"); ?>';
