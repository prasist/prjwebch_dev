...
<html lang="pt-br">
    <head X-Frame-Options: DENY>
        ...
        <script src="<?php echo e(asset('/dist/js/jquery-2.0.3.min.js')); ?>"></script>
        ...
        <link href="<?php echo e(asset('/dist/css/sweetalert.css')); ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo e(asset('/dist/css/bootstrap-datepicker3.css')); ?>" rel="stylesheet" type="text/css" />


        <!--  OFFLINE-->
        <link href="<?php echo e(asset('/plugins/daterangepicker/daterangepicker-bs3.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="<?php echo e(asset('/plugins/datatables/dataTables.bootstrap.css')); ?>"/>
        <link rel="stylesheet" href="<?php echo e(asset('/dist/css/hopscotch.min.css')); ?>"/>
        <link rel="stylesheet" href="<?php echo e(asset('/dist/css/buscapessoas.css')); ?>"/>
        <link href="<?php echo e(asset('/dist/css/bootstrap-switch.min.css')); ?>" rel="stylesheet"/>
        <link href="<?php echo e(asset('/dist/css/bootstrap-treeview.min.css')); ?>" rel="stylesheet"/>
        <link href="<?php echo e(asset('/dist/css/pace.min.css')); ?>" rel="stylesheet"/>
        <link href="<?php echo e(asset('/dist/css/bootstrap-editable.css')); ?>" rel="stylesheet" type="text/css" />
        <script src="<?php echo e(asset('/dist/js/bootstrap-editable.js')); ?>"></script>
        ...
        <link href="<?php echo e(asset('/dist/css/skins/skin-green.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('/dist/css/bootstrap-timepicker.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('/dist/css/pick-a-color-1.1.8.min.css')); ?>" rel="stylesheet"/>
        <link href="<?php echo e(asset('/dist/css/treeview.css')); ?>" rel="stylesheet"/>

        <!--ANGULAR-->
        <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.5.8/angular.min.js"></script>
        <!--<script src="<?php echo e(asset('/angular/app.js')); ?>"></script>-->
        <!--<script src="<?php echo e(asset('/angular/modules/celulas/controllers/celulas.main.controller.js')); ?>"></script>
        <script src="<?php echo e(asset('/angular/controllers/loadselect.ctrl.js')); ?>"></script>-->

        <link href="<?php echo e(asset('/dist/css/xeditable.css')); ?>" rel="stylesheet"/>
        <script src="<?php echo e(asset('/dist/js/xeditable.js')); ?>"></script>
        <!-- FIM ANGULAR -->
            ...
            <div class="content-wrapper">
                ...
                <section id="tst" class="content-header">
                    ...
                    <?php if(Session::has('titulo')): ?>
                          <?php echo e(Session::get('titulo')); ?>

                    <?php endif; ?>
                    <small>
                    <?php if(Session::has('subtitulo')): ?>
                        <?php echo e(Session::get('subtitulo')); ?>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                        <?php if(Session::has('route')): ?>
                            <a href="<?php echo e(url(Session::get('route'))); ?>"> <?php echo e(Session::get('route')); ?></a>
                        <?php endif; ?>
                        </li>
                        <li class="active">
                        <?php if(Session::has('titulo')): ?>
                ...
                <section class="content">
                    ...
                    <?php if(Session::has('flash_message_erro')): ?>

                            <div class="alert alert-danger alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <h4><i class="icon fa fa-check"></i> Erro!</h4>
                                <?php echo e(Session::get('flash_message_erro')); ?>
...
<script src="<?php echo e(asset('/dist/js/bootstrap-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('/dist/js/tinycolor-0.9.15.min.js')); ?>"></script> <!-- monetarios-->
<script src="<?php echo e(asset('/dist/js/pick-a-color-1.1.8.min.js')); ?>"></script> <!-- monetarios-->
                  ...
                  $(function ()
                  {
                            ...
                            */
                            ...
                            $('input.typeahead').typeahead({
                                name: 'typeahead',
                                remote:'<?php echo url("/buscapessoa/%QUERY"); ?>',
                                limit : 50
                            });
    ...
    function confirmar_cadastro(objInput)
    {
        ...
        $('input.novo_valor_' + objInput).each(function()
        {
                ...
                if ($(this).val()!="") //Se encontrar valor
                {
                    ...
                    var urlRoute = "<?php echo url('/cadastrar/json/" + var_query + "'); ?>";
                    ...
                    $.ajax({
                        ...
                        success: function (data){
                                ...
                                var urlRouteCarregar = "<?php echo url('/carregar_tabela/" + var_parametros[1].trim() + "'); ?>";
...
<?php echo $__env->yieldContent('tela_permissoes'); ?>

<?php echo $__env->yieldContent('tela_usuarios'); ?>

<?php echo $__env->yieldContent('tela_pessoas'); ?>

<?php echo $__env->yieldContent('busca_endereco'); ?>

<?php echo $__env->yieldContent('data_table_custom'); ?>
...
<!-- Adicionando JQuery -->
        ...
        <script src="<?php echo e(asset('/dist/js/bootstrap-treeview.min.js')); ?>"></script>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('/dist/css/morris.css')); ?>">

        <!--<script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>-->
        <script src="<?php echo e(asset('/dist/js/raphael-min.js')); ?>"></script>

        <!--<script src="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.min.js"></script>-->
        <script src="<?php echo e(asset('/dist/js/morris.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('/dist/js/hopscotch.min.js')); ?>"></script>
        <script src="<?php echo e(asset('/js/tour_sigma3.js')); ?>"></script>
        <script src="<?php echo e(asset('/js/typeahead.min.js')); ?>"></script>
        <script src="<?php echo e(asset('/dist/webcam.js')); ?>"></script>
        <script src="<?php echo e(asset('/dist/js/bootstrap-checkbox.min.js')); ?>" defer></script>
        <script src="<?php echo e(asset('/dist/js/moment.min.js')); ?>"></script> <!-- datas-->
        <script src="<?php echo e(asset('/dist/js/autoNumeric-min.js')); ?>"></script> <!-- monetarios-->
        <script src="<?php echo e(asset('/dist/js/bootstrap-switch.min.js')); ?>"></script>
        <script src="<?php echo e(asset('/dist/js/bootstrap-timepicker.min.js')); ?>"></script>
        <script src="<?php echo e(asset('/dist/js/treeview.js')); ?>"></script>
        <script src="<?php echo e(asset('/dist/js/pace.min.js')); ?>"></script>

    <!--
    <script type="text/javascript" language="javascript" src="<?php echo e(asset('/dist/js/dataTables.buttons.min.js')); ?>"></script>
    <script type="text/javascript" language="javascript" src="<?php echo e(asset('/dist/js/pdfmake.min.js')); ?>"></script>
    <script type="text/javascript" language="javascript" src="<?php echo e(asset('/dist/js/vfs_fonts.js')); ?>"></script>
    <script type="text/javascript" language="javascript" src="<?php echo e(asset('/dist/js/buttons.html5.min.js')); ?>"></script>
    -->


        <?php if(\Session::get('membro')=='' || \Session::get('membro')=='N'): ?>
                <!-- tour rápido-->
                <?php if(\Session::get('tour_visaogeral')=='' || \Session::get('tour_visaogeral')!='S'): ?>
                    <?php if(\Session::get('dados_login')!=''): ?>
                    <script type="text/javascript">
                ...
                <?php if(\Session::get('tour_rapido')==' ' || \Session::get('tour_rapido')!='S'): ?>
