...
class DonsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rota = "dons"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = dons::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
