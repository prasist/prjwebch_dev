...
use App\Models\tiposmovimentacao;
use URL;
use Auth;
use Input;
use Gate;

class TiposMovimentacaoController extends Controller
{

    public function __construct()
    {

        $this->rota = "tiposmovimentacao"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = tiposmovimentacao::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
        ...
        $dados = tiposmovimentacao::findOrfail($id);
