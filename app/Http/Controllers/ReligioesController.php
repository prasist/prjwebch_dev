...
use App\Models\religioes;
use URL;
use Auth;
use Input;
use Gate;

class ReligioesController extends Controller
{

    public function __construct()
    {

        $this->rota = "religioes"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = religioes::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
