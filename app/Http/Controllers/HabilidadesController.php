...
class HabilidadesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rota = "habilidades"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = habilidades::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
        ...
        $dados = habilidades::findOrfail($id);
