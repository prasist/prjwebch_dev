...
class GruposPessoasController extends Controller
{

    public function __construct()
    {

        $this->rota = "grupospessoas"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = grupospessoas::where('empresas_clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
        ...
        $dados = grupospessoas::findOrfail($id);
