...
use App\Models\grausparentesco;
use URL;
use Auth;
use Input;
use Gate;

class GrausParentescoController extends Controller
{

    public function __construct()
    {

        $this->rota = "grausparentesco"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = grausparentesco::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
        ...
        $dados = grausparentesco::findOrfail($id);
