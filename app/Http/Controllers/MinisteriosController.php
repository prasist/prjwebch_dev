...
class MinisteriosController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rota = "ministerios"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = ministerios::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
        ...
        $dados = ministerios::findOrfail($id);
