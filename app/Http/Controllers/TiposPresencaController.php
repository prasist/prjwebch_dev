...
use App\Models\tipospresenca;
use URL;
use Auth;
use Input;
use Gate;

class TiposPresencaController extends Controller
{

    public function __construct()
    {

        $this->rota = "tipospresenca"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = tipospresenca::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
        ...
        $dados = tipospresenca::findOrfail($id);
