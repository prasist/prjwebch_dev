...
class ProfissoesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rota = "profissoes"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = profissoes::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
        ...
        $dados = profissoes::findOrfail($id);
