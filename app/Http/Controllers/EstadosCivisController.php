...
class EstadosCivisController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rota = "civis"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = civis::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
