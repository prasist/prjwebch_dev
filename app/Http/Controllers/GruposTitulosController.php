...
use App\Models\grupos_titulos;
use URL;
use Auth;
use Input;
use Gate;

class GruposTitulosController extends Controller
{

    public function __construct()
    {

        $this->rota = "grupos_titulos"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = grupos_titulos::where('empresas_clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
