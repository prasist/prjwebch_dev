...
class StatusController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rota = "status"; //Define nome da rota que será usada na classe
    ...
    public function index()
    {
        ...
        $dados = status::where('clientes_cloud_id', $this->dados_login->empresas_clientes_cloud_id)->get();
